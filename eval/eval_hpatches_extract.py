...
parser.add_argument('--checkpoint', type=str, default='../trained_models/best_2021-03-06_00:42_sparsencnet.pth.tar')
...
parser.add_argument('--experiment_name', type=str, default='debugging_chmnet')
